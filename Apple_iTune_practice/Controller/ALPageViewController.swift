...
class ALPageViewController: UIPageViewController {
    ...
    lazy var controllers: [UIViewController] = {
        ...
        let detailVC = storyboard.instantiateViewController(withIdentifier: String(describing: SavedDetailViewController.self))
...
extension ALPageViewController: UIPageViewControllerDelegate {
    ...
    func pageViewController(_ pageViewController: UIPageViewController, willTransitionTo pendingViewControllers: [UIViewController]) {
        ...
        guard let savedDetailVC = pendingViewControllers.first as? SavedDetailViewController else { return }
        self.configureDisplaying(viewController: savedDetailVC)
    }
    
    func pageViewController(_ pageViewController: UIPageViewController, didFinishAnimating finished: Bool, previousViewControllers: [UIViewController], transitionCompleted completed: Bool) {
        
        guard let previousVC = previousViewControllers.first as? SavedDetailViewController else { return }
